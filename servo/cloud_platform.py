...
class CloudPlatform(object):
    def __init__(self, i2c, btm_servo_idx, top_servo_idx, btm_init_angle=0, top_init_angle=9):
        '''
        ...
        self.btm_max_angle = 270  # 底部舵机最大旋转角度

        self.top_min_angle = 0  # 顶部舵机的最小旋转角度
        self.top_max_angle = 270  # 顶部舵机的最大旋转角度

        self.btm_init_angle = btm_init_angle  # 底部舵机的初始角度
        self.top_init_angle = top_init_angle  # 顶部舵机的初始角度
